...
class LoadAnnotations3DLane(LoadAnnotations3D):
    ...
    def __init__(self,
                 ...
                 with_bbox_3d=False,
                 with_label_3d=False,
                 with_lane_lcte_adj_only_ls=True,
                 **kwargs):
        ...
        self.with_lane_lcte_adj_only_ls = with_lane_lcte_adj_only_ls
    def _load_lanes_3d(self, results):
        ...
        if self.with_lane_lcte_adj_only_ls:
            results['gt_lane_lcte_adj_only_ls'] = results['ann_info']['gt_lane_lcte_adj_only_ls']
        return results
